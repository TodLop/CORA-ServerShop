package com.todlop.servershop.commands;

import com.todlop.servershop.ServerShop;
import com.todlop.servershop.LeaderboardManager;
...
public class BuyCommand implements CommandExecutor, TabCompleter {
    ...
    private boolean handleSethomeCommand(CommandSender sender, String[] args) {
        ...
        Player player = (Player) sender;
        com.todlop.servershop.SetHomeSlotPurchaseHandler handler =
                new com.todlop.servershop.SetHomeSlotPurchaseHandler(plugin);
    ...
    private boolean handleNicknameCommand(CommandSender sender, String[] args) {
        com.todlop.servershop.NicknameChangeHandler handler =
                new com.todlop.servershop.NicknameChangeHandler(plugin);
    ...
    private boolean handleAnvilCommand(CommandSender sender, String[] args) {
        ...
        Player player = (Player) sender;
        com.todlop.servershop.AnvilAccessHandler handler =
                new com.todlop.servershop.AnvilAccessHandler(plugin);
    ...
    private boolean handleCraftCommand(CommandSender sender, String[] args) {
        ...
        Player player = (Player) sender;
        com.todlop.servershop.CraftAccessHandler handler =
                new com.todlop.servershop.CraftAccessHandler(plugin);
    ...
    private boolean handleAuctionCommand(CommandSender sender, String[] args) {
        ...
        if (args.length > 1 && args[1].equalsIgnoreCase("info")) {
            com.todlop.servershop.AuctionLimitPurchaseHandler handler =
                    new com.todlop.servershop.AuctionLimitPurchaseHandler(plugin);
